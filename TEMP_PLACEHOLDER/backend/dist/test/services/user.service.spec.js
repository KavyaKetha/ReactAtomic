...
const utils = __importStar(require("../../src/utils/encryption.util"));
...
describe('User Service', () => {
    ...
    describe('signIn', () => {
        it('should return user data and token on successful sign in', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            utils.decrypt.mockReturnValue(true);
        ...
        it('should throw BadRequestException on wrong password', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            userDao.signIn.mockResolvedValue(mockUser);
            utils.decrypt.mockReturnValue(false);
            yield expect((0, user_service_1.signIn)(mockUser.email, 'wrongpassword')).rejects.toThrow(errorMiddleware_1.BadRequestException);
        }));
